...
public class RetraitManager {
	...
	public void updateRetrait(int no_Retrait, ArticleVendu no_article,String rue, String code_postal, String ville) throws BusinessException {
		Retrait retraitAModifier = new Retrait(no_Retrait,no_article, rue, code_postal, ville);
